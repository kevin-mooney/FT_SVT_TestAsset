...
public class AFT_asset_nav_Schedule_NC78DB70004511E99BC1DA4D1F2AFAAE
		extends com.ibm.rational.test.lt.kernel.action.impl.Schedule {

	public AFT_asset_nav_Schedule_NC78DB70004511E99BC1DA4D1F2AFAAE(IContainer parent, String name) {
		super(parent, name, "NC78DB70004511E99BC1DA4D1F2AFAAE");
		setThinkMax(2000);
	...
	public class UserGroup_1 extends UserGroup {
		...
		public UserGroup_1(IContainer parent) {
			super(parent, "chrome 1", "A1E930451C8EAD70FE67E23836366663");
		...
		private Container scenario_1(IContainer parent) {
			Container scenario = new Container(parent, "scenario_1", "A1E930451C8EAD7BFE67E23836366663") {
				...
				public void execute() {
					this.add(new test.Test1_2__Test_A1E93044968CF3C0FE67E23836366663(this,
							"A1E930451C8EAD88FE67E23836366663") {
						public void execute() {
	...
	public class UserGroup_2 extends UserGroup {
		...
		public UserGroup_2(IContainer parent) {
			super(parent, "chrome 2", "A1E930451C8EAD95FE67E23836366663");
		...
		private Container scenario_2(IContainer parent) {
			Container scenario = new Container(parent, "scenario_2", "A1E930451C8EADA0FE67E23836366663") {
				...
				public void execute() {
					this.add(new test.Test1_Test_A1E930332F64A0A0FE67E23836366663(this,
							"A1E930451C8EADADFE67E23836366663") {
						public void execute() {
							this.setRtbEnabled(false);
							super.execute();
						}
	...
	public class UserGroup_3 extends UserGroup {
		...
		public UserGroup_3(IContainer parent) {
			super(parent, "firefox 3", "A1E930451C8ED47BFE67E23836366663");
		...
		private Container scenario_3(IContainer parent) {
			Container scenario = new Container(parent, "scenario_3", "A1E930451C8ED486FE67E23836366663") {
				...
				public void execute() {
					this.add(new test.Test1_2__Test_A1E93044968CF3C0FE67E23836366663(this,
							"A1E930451C8ED493FE67E23836366663") {
						public void execute() {
							this.setRtbEnabled(false);
							super.execute();
						}
	...
	public class UserGroup_4 extends UserGroup {
		...
		public UserGroup_4(IContainer parent) {
			super(parent, "firefox 4", "A1E930451C8ED4A0FE67E23836366663");
		...
		private Container scenario_4(IContainer parent) {
			Container scenario = new Container(parent, "scenario_4", "A1E930451C8ED4ABFE67E23836366663") {
				...
				public void execute() {
					this.add(new test.Test1_Test_A1E930332F64A0A0FE67E23836366663(this,
							"A1E930451C8ED4B8FE67E23836366663") {
						public void execute() {
							this.setRtbEnabled(false);
							super.execute();
						}
