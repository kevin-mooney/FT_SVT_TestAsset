...
public class PlantsByWebSphere_Test_A1E945565ACBCB00EA50B53262373237 extends LTTestScript  {
...
pa.addPA("com.ibm.rational.test.lt.execution.moeb.dc.MoebDataAdapter", "com.ibm.rational.test.lt.execution.moeb.action.MoebStepBatchAction");
	...
	public PlantsByWebSphere_Test_A1E945565ACBCB00EA50B53262373237(IContainer container, String invocationId) {
		super(container, "PlantsByWebSphere", invocationId, "A1E945565ACBCB00EA50B53262373237");
		setArmEnabled(false);
...
this.addEventBehavior(new RPTEventStructure(new RPTFailVPEvent(), new RPTContinueEvent("Content Verification Point failed"), 1, "Content Verification Point failed"));
	...
	this.add(applicationContext_8(this));
			this.addFinally(new EndMoebStepBatchAction(this));
		     ...
		     log("Test Execution: PlantsByWebSphere_Test_A1E945565ACBCB00EA50B53262373237 ",e);
	    } finally {
	        super.execute();
		}	    
    }
...
private VariableAction varAction_1(final IContainer parent) {
	...
	VariableAction vc = new VariableAction(parent, "", "A1E940B07F27D76EFAE0E66162386564");	
		...
		vars[1] = new DataVar("password", "jhansi", IDataArea.VIRTUALUSER, "IGNORE", false, false);

	
		vars[2] = new DataVar("emailAddress", "jhansi", IDataArea.VIRTUALUSER, "IGNORE", false, false);
	...
	public MoebStepBatchAction applicationContext_1(IContainer parent) {
		MoebStepBatchAction stepBatch = new MoebStepBatchAction(parent,
												  ...
												  "/9211_WebUITestPrj1/PlantsByWebSphere.testsuite",
	...
	ISubRule sub_0 = new SubRule("MOEB_FIELD/TPM:A1E940B07FB91AD7FAE0E66162386564", 0, 22, false, (IDCCoreVar)vars[2], false, "vatsalaswamy.s@hcl.com_2", null, 0, false);
