...
public class LaunchTest1_Test_A1E93C2DE074D9E0F2F2B13832356564 extends LTTestScript  {
...
pa.addPA("com.ibm.rational.test.lt.datacorrelation.execution.protocol.core.CoreProtoAdapter", "coreAdapter");
	...
	public LaunchTest1_Test_A1E93C2DE074D9E0F2F2B13832356564(IContainer container, String invocationId) {
		super(container, "LaunchTest1", invocationId, "A1E93C2DE074D9E0F2F2B13832356564");
		setArmEnabled(false);
...
this.addEventBehavior(new RPTEventStructure(new RPTFailVPEvent(), new RPTContinueEvent("Content Verification Point failed"), 1, "Content Verification Point failed"));
	...
	this.add(applicationContext_4(this));
			this.addFinally(new EndMoebStepBatchAction(this));
		     ...
		     log("Test Execution: LaunchTest1_Test_A1E93C2DE074D9E0F2F2B13832356564 ",e);
	    } finally {
	        super.execute();
		}	    
    }
	...
	public MoebStepBatchAction applicationContext_1(IContainer parent) {
		MoebStepBatchAction stepBatch = new MoebStepBatchAction(parent,
												  ...
												  "/WebUI95/Tests/LaunchTest1.testsuite",
												  null,
												  "<default>");
